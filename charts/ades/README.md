...
| workflowExecutor.processingKeepWorkspaceIfFailed | if false the Ades will clean the namespace after the workflow has finished but will keep it in case of error  | `false`| workflowExecutor.main.cwl             | Main CWL workflow file path used by [`cwl-wrapper`](https://github.com/EOEPCA/cwl-wrapper)                                                          | `empty` |
